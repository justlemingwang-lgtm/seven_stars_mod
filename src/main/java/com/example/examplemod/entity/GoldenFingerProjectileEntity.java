...
public class GoldenFingerProjectileEntity extends ThrowableItemProjectile {
    private float damage = 10.0F;
    private double maxRange = 16.0D;
    private int drainQi = 40;
    private double startX;
    private double startY;
    private double startZ;

    public GoldenFingerProjectileEntity(EntityType<? extends GoldenFingerProjectileEntity> type, Level level) {
        super(type, level);
    }
